...
const AboutUs = () => {
  ...
  return (
    <div className="bg-white min-h-screen ">
      ...
      {/* Hero Section */}
      <section className="bg-[#232323] lg:rounded-xl max-w-[82rem] mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-6 px-2 py-8 md:py-12 md:px-12 mb-10">
        {/* Left: Text */}
      ...
      {/* Partners Section */}
      <section className="max-w-[82rem] mx-auto px-2 mb-16">
